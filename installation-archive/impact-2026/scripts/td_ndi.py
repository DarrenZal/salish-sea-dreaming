...
Default points at the 3090's localhost; set TD_EXEC_URL or pass --host to
target it from another machine (e.g. via SSH tunnel `ssh -L 9981:localhost:9981 windows-desktop`).
