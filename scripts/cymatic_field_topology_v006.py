...
"""
Cymatic field topology v006.

Internal scalar-field / standing-wave topology probe for Salish Sea Dreaming
Phase 2. v006 keeps the v005 full-field two-tone positive/negative region
beauty layer, then tests lattice quantization: exact source lattices should
crystallize repeated primitive cells, while low lattice clarity should dissolve
the same field back into irregular water-like motion.
...
OUT_DIR = (
    ...
    / "cymatic_field_topology_v006_2026-05-20"
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Render cymatic field topology v006 packet.")
    parser.add_argument(
        "--clip",
    ...
    if args.clip == "all":
        ...
        print(f"Wrote cymatic field topology v006 packet to {OUT_DIR}")
    else:
