...
"""
Cymatic field topology v005.

Internal scalar-field / standing-wave topology probe for Salish Sea Dreaming
Phase 2. v005 follows the v004 takeaway: the strongest visuals were the
positive/negative debug regions and negative-space silhouette, not sparse
feature overlays. The beauty render is now a bounded, full-field, two-tone
region composition. Circle/crescent/trigon-like forms are allowed to emerge
from the scalar-field regions and from hard boundary cuts.
...
OUT_DIR = (
    ...
    / "cymatic_field_topology_v005_2026-05-20"
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Render cymatic field topology v005 packet.")
    parser.add_argument(
        "--clip",
    ...
    if args.clip == "all":
        ...
        manifest = write_manifest(summaries, contact_sheet, debug_sheet, phase_sheet)
        ...
        print(f"Wrote cymatic field topology v005 packet to {OUT_DIR}")
    else:
