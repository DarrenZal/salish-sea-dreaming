...
- **The body's shape:** two hands' fingertips touching.
- **The code's shape:** a sum-of-distances dropping below a threshold.
- **The ecosystem's shape:** a herring formed of many small lives.
- **The worldview's shape:** sympoiesis — making-with, never alone.
